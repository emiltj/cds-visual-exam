...
cd ../..
mkdir -p assignment_self/data/content_gauguin_style_gauguin #Make new folders
mkdir assignment_self/data/content_monet_style_monet
cp assignment_5/data/training/Gauguin/* assignment_self/data/content_gauguin_style_gauguin/ # Copy training data of gauguin to new folder
cp assignment_5/data/validation/Gauguin/* assignment_self/data/content_gauguin_style_gauguin/ # Copy validation data of gauguin to new folder
